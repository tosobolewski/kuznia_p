...
Zmieñ program PESEL z poprzedniej lekcji w ten sposób, aby sprawdza³, czy podana data jest prawid³owa. SprawdŸ ile miesi¹c ma dni i czy jest to rok przestêpny. 
Przyk³adowo data 31.04.2010 jest nieprawid³owa, poniewa¿ kwiecieñ ma 30 dni.

Zadanie nale¿y zrobiæ u¿ywaj¹c nastêpuj¹cej funkcji:
bool dateValidation(int year, int month, int day);

Zmienna year bêdzie wys³ana jako liczba czterocyfrowa. W programie mo¿na u¿yæ wiêkszej iloœci funkcji, ta jedna jest jednak wymagana dok³adnie w takiej postaci.
